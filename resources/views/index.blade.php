				...
				<div class="col-lg-8 col-md-10 novo ">
					...
					<form action="" method="">
					  ...
					  <div class="form-group d-flex">
					    ...
					    <input type="email" class="form-control prvi" id="email" placeholder="Your email" >
					...
					<div class="row">
						...
						<form action="" method="" class="pr-3 pl-3">
						  ...
						  <div class="form-group  ">
						    ...
						    <textarea name="" id="" cols="30" rows="10" id="question" class="form-control" placeholder="Your question"></textarea>
						  </div>
